...
def linkedin_lookup_agent(name: str) -> str:
    ...
    template = """given the full name {name_of_person} I want you to get me a link to
        their LinkedIn profile page. The answer should only contain the URL without any description"""

    tools_for_agent = [
        Tool(
            name="Crawl Google for LinkedIn profile page",
            func=get_profile_url,
            description="useful when you want to get the URL of a person LinkedIn page"
        )
    ]
